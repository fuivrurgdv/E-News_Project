                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div>
                                ...
                                <button type="button" onclick="window.location.href = ''">Manage Comment</button>
                            </div>
                                        ...
                                        <c:forEach items="${listComment}" var="comment">
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="commentManage?commentId=${comment.commentId}&status=${comment.status}">${comment.status==1 ?"khả dụng":"không khả dụng" }</a>
