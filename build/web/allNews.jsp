                                    ...
                                    <div class="position-relative mb-3">
                                        ...
                                        <div class="bg-white border border-top-0 p-4">
                                            <div class="mb-2">
                                                ...
                                                <a class="text-body" href="newsdetail?aid=${lista.getArticleId()}"><small>${lista.getPublishedDate()}</small></a>
                                            </div>
                                            <a class="h4 d-block mb-3 text-secondary text-uppercase font-weight-bold" href="newsdetail?aid=${lista.getArticleId()}">${lista.getTitle()}</a>
