...
public class AllNewsServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (categoryID != null) {
            ...
            listAll = adao.getArticlesByCategoryID(id);
            if (listAll.isEmpty()) {
                mess = "Not Found!";
            }
             categoryName = cdao.getNameCategoryByID(id);
            
        } else {
            listAll = adao.getAllNews();
        }

        request.setAttribute("mess", mess);
        request.setAttribute("allNews", listAll);
